...
export default function PrivacyPolicy() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[var(--background)] text-[var(--foreground)] selection:bg-purple-200">
      {/* Background Orbs */}
      <div className="absolute top-0 -left-1/4 w-[600px] h-[600px] bg-purple-200/30 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-0 -right-1/4 w-[600px] h-[600px] bg-blue-200/30 rounded-full blur-[120px] pointer-events-none" />

      {/* Navigation */}
      <nav className="fixed top-0 w-full z-50 px-6 py-6 border-b border-black/5 backdrop-blur-md bg-white/70">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <Link href="/" className="flex items-center gap-2 group">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-purple-500 to-blue-500 flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-lg shadow-purple-500/20">
      ...
      <div className="pt-40 pb-32 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <motion.div
            ...
            className="mb-20"
          >
            <span className="px-4 py-1.5 rounded-full border border-purple-100 bg-purple-50 text-sm font-medium text-purple-600 mb-6 inline-block shadow-sm">
              Effective Date: May 8, 2024
            </span>
            <h1 className="text-5xl md:text-7xl font-bold tracking-tighter mb-8 bg-clip-text text-transparent bg-gradient-to-b from-gray-900 via-gray-800 to-gray-500">
          ...
          <div className="grid gap-8">
            {sections.map((section, i) => (
              <motion.div
                ...
                className="p-8 md:p-10 rounded-3xl border border-gray-100 bg-white hover:border-purple-200 hover:shadow-xl transition-all group relative overflow-hidden"
              >
                <div className="flex items-start gap-6 relative z-10">
                   <div className="w-12 h-12 rounded-2xl bg-gray-50 border border-gray-100 flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform duration-500">
                      {section.icon}
                   </div>
                   <div>
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="p-8 md:p-12 rounded-[2.5rem] bg-gradient-to-br from-purple-600 to-blue-600 border border-transparent relative overflow-hidden group shadow-2xl"
            >
               <div className="relative z-10">
                  ...
                  <a 
                    ...
                    className="inline-flex items-center gap-3 px-8 py-4 rounded-full bg-white text-black font-bold hover:scale-105 transition-transform shadow-lg"
                  >
               ...
               <div className="absolute -bottom-1/2 -right-1/4 w-64 h-64 bg-white/10 rounded-full blur-3xl" />
            </motion.div>
          </div>
        </div>
      </div>
      ...
      {/* Footer */}
      <footer className="py-12 px-6 border-t border-gray-100 text-gray-500 bg-white">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="flex items-center gap-2">
            <Sparkles className="w-5 h-5 text-purple-600" />
            <span className="font-bold text-gray-900">Pixie Webs</span>
          </div>
          <div className="flex gap-8 text-sm">
            ...
            <Link href="/privacy" className="hover:text-black transition-colors underline underline-offset-4 decoration-gray-200">Privacy Policy</Link>
          </div>
          <p className="text-sm">
