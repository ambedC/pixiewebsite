...
export function FAQ1() {
  ...
  return (
    <div className={`relative w-full overflow-hidden transition-colors duration-700 ${palette.surface} rounded-t-[3rem] shadow-[0_-20px_50px_rgba(0,0,0,0.05)] -mt-10 pb-32`}>
      ...
      <section
        className={`relative z-10 mx-auto flex max-w-4xl flex-col gap-12 px-6 pt-32 lg:max-w-5xl lg:px-12 ${
